...
Lonum		INT UNSIGNED	NOT NULL,
Seat		INT UNSIGNED	,
FOREIGN KEY(Lonum) REFERENCES LOCATION (Lnumber),
...
Eftime		TIME		,
Eday		VARCHAR(10)	,
FOREIGN KEY(Lno) REFERENCES LOCATION (Lnumber),
...
Mtime		DATETIME	,
PRIMARY KEY(Mnumber),
FOREIGN KEY(Enum) REFERENCES EXAM (Enumber),
