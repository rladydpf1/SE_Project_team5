...
-- 교수 시험 일정 목록 출력
SELECT	Cnumber, Cname, Exam_room, Estime, Eftime, Eday
FROM	COURSE, EXAM, PROFESSOR, CLASSROOM
...
-- 학생 시험 일정 목록 출력
SELECT	Cnumber, Cname, Exam_room, Estime, Eftime, Eday
FROM	COURSE, EXAM, STUDENT, TAKE_CLASS, CLASSROOM
...
FROM	COURSE, STUDENT, TAKE_CLASS, CLASSROOM, CLASSHOUR
